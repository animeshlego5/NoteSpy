...
## 1. Overview
**NoteSpy** is a modern, high-performance music recognition web application. Inspired by Shazam, it allows users to identify songs by recording audio directly from their browser. The project emphasizes a premium user experience and a clean interface.
